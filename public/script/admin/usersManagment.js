    /* -------------------- CONFORM MODAL -------------------- */
        ...
        function openUserModal(userId, isActive) {
            ...
            if (isActive) {
                ...
                btn.innerText = 'Block';
                btn.className = 'px-6 py-2.5 bg-red-800 hover:bg-red-900 text-white rounded-md';
            } else {
                title.innerText = 'Unblock User';
                msg.innerText = 'Are you sure you want to unblock this user?';
                btn.innerText = 'Unblock';
                btn.className = 'px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-md';
            }
  ...
  users.forEach(user => {
    tableBody.innerHTML += `
      <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4">
          <button onclick="openUserModal('${user._id}', ${user.isActive})"
